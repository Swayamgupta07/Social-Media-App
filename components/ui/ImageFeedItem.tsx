...
export default function ImageFeedItem({ post, onLike, onRetweet, onReply }: ImageFeedItemProps) {
    ...
    <>
      <div className="bg-white dark:bg-black p-4 border-b border-gray-100 dark:border-gray-800">
        ...
        <div className="flex items-start space-x-3">
          <div className="w-12 h-12 flex items-center justify-center overflow-hidden rounded-full bg-gray-100 dark:bg-gray-800">
            <img 
          ...
          <div className="flex-1 min-w-0">
            ...
            {post.media && post.media.length > 0 && (
              <div className="mb-3 rounded-2xl overflow-hidden bg-gray-100 dark:bg-gray-800">
                <img 
